class Constant {
  ...
  static const ARG_RECENTCOMMENT = 'most_recent_comment';

  static const ARG_PHOTOMEMOLIKE = 'photomemo_like';
  static const ARG_PHOTOCOMMENTLIST = 'photocomment_list';
  static const ARG_PROFILELIST = 'profile_list';
  static const ARG_TAGGEDME = 'tagged_me';
  ...
  static const PHOTOMEMO_COMMENT = 'photoComments';
  static const PROFILE = 'profile';
  static const PHOTOMEMO_COLLECTION = 'photoMemos';
  static const PHOTOMEMO_LIKE = 'photoLikes';

  static const ARG_DOWNLOADURL = 'downloadurl';
  static const ARG_FILENAME = 'filename';
  static const MIN_ML_CONFIDENCE = 0.7; //ML confidence
}
