...
class _DetailedViewState extends State<DetailedViewScreen> {
  ...
  Future<String> _getLikes(String memoId) async {
    List<PhotoLike> result = await FirebaseController.getPhotoLikes(memoId);
    if (result.length == 0) return 'No Likes';
