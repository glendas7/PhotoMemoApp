              ...
              children: [
                Center(
                  child: Text('Nostalgia:',
                      style: TextStyle(fontFamily: 'RockSalt', fontSize: 60.0)),
                ),
                Center(
                  child: Text('A PhotoMemo App',
                      style: TextStyle(fontFamily: 'RockSalt', fontSize: 30.0)),
                ),
                Text(
                  'Sign in, please!',
                  style: TextStyle(fontFamily: 'Satisfy', fontSize: 26.0),
                ),
                TextFormField(
...
class _Controller {
  ...
  void signIn() async {
    ...
    try {
      ...
      print('list size is: ${photoMemoList.length}');
